...
type typ = Int | Bool | Double| Void | String | Object of string | 
IntList of string list
    | BoolList of string list| DoubleList of string list | StringList of string list | ObjectList of string * string list
...
let string_of_type = function
  ...
  | BoolList -> "bool[]"
  | StringList -> "string[]" *)
  | IntList (l) -> "int" ^ String.concat "" l
  | DoubleList (l) -> "double" ^ String.concat "" l
  | BoolList(l) -> "bool" ^ String.concat "" l
  | StringList(l) -> "string" ^ String.concat "" l
  | ObjectList(s, l) -> s ^ String.concat "" l
